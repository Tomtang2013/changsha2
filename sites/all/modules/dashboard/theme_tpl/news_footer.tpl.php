<div class="news_footer">
    ...
    <div class="friend_link">
        <span>友情链接</span>
        <span><a href=""><img class="friend_link_img" src="<?php print drupal_get_path('module', 'dashboard'); ?>/image/footer/group01.png" alt=""></a></span>
        <span><a href=""><img class="friend_link_img" src="<?php print drupal_get_path('module', 'dashboard'); ?>/image/footer/group02.png" alt=""></a></span>
    </div>
    <div class="new_media">
        <span>新媒体</span>
